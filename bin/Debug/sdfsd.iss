...
#define MyAppExeName "dopaminefood-app.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{5141042D-87BB-476E-8881-B5DE37BEB4B6}
AppName={#MyAppName}
...
[Files]
Source: "C:\dopamin\dopamineteam\MobileCenterAbadan\bin\Debug\dopaminefood-app.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\dopamin\dopamineteam\MobileCenterAbadan\bin\Debug\dopafood51.mdf"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\dopamin\dopamineteam\MobileCenterAbadan\bin\Debug\dopafood51_log.ldf"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\dopamin\dopamineteam\MobileCenterAbadan\bin\Debug\dopaminefood-app.exe"; DestDir: "{app}"; Flags: ignoreversion
