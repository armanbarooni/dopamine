...
#define MyAppExeName "dopafood_app.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{E97B362E-A5D7-4643-A6E4-5A2B81ABDF90}
AppName={#MyAppName}
...
OutputBaseFilename=setup_5.3_final
Compression=lzma
...
[Files]
Source: "C:\dopamin\dopamineteam\MobileCenterAbadan\bin\Debug\dopafood_app.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\dopamin\dopamineteam\MobileCenterAbadan\bin\Debug\dopafood_app.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\dopamin\dopamineteam\MobileCenterAbadan\bin\Debug\dopafood52.mdf"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\dopamin\dopamineteam\MobileCenterAbadan\bin\Debug\dopafood52_log.ldf"; DestDir: "{app}"; Flags: ignoreversion
