...
#define MyAppExeName "MobileCenterAbadan.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{386CA80B-5493-4E9B-B010-DCF4404A1B39}
AppName={#MyAppName}
...
[Files]
Source: "C:\dopamin\dopamineteam\MobileCenterAbadan\bin\Debug\MobileCenterAbadan.exe"; DestDir: "{app}"; Flags: ignoreversion
